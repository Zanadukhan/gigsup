...
const Card = (props) => {
    return (
        <div className='mt-10'>
            <div className="max-w-sm bg-[#CFFF81] border-[#FFB9B8] border-solid border-8 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                ...
                <div className="p-5">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 bg-[#CFFF81]">{props.text}</p>
                </div>
            </div>
